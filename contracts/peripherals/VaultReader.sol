...
contract VaultReader {
    function getVaultTokenInfoV3(address _vault, address _positionManager, address _weth, uint256 _usddAmount, address[] memory _tokens) public view returns (uint256[] memory) {
    ...
    function getVaultTokenInfoV4(address _vault, address _positionManager, address _weth, uint256 _usddAmount, address[] memory _tokens) public view returns (uint256[] memory) {
